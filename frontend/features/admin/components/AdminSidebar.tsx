...
import { BarChart3, CalendarDays, ClipboardList, LogOut, Megaphone, PanelLeftClose, PanelLeftOpen, QrCode, ScanLine, TicketCheck, Users } from "lucide-react";
...
export function AdminSidebar({
  ...
  const userIcons = { exhibitions: CalendarDays, reservations: ClipboardList, "qr-ticket": QrCode, "vip-ads": Megaphone };
