...
/**
 * {@code example-vault-cert}가 자기 세션 갱신용 {@code TaskScheduler} 빈("exampleVaultSessionTaskScheduler")을
 ...
 * {@code @Qualifier("exampleVaultSessionTaskScheduler")}로 자기 빈을 콕 집어 쓰므로 이 빈 추가와 무관하다.
 */
@Configuration
